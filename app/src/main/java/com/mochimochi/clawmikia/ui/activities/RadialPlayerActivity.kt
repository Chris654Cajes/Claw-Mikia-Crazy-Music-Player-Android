...
import com.mochimochi.clawmikiacrazy.databinding.ActivityRadialPlayerBinding
...
class RadialPlayerActivity : AppCompatActivity() {

    private lateinit var binding: ActivityRadialPlayerBinding
    ...
    companion object {
        ...
        fun start(ctx: Context, songId: Long) =
            ctx.startActivity(
                Intent(ctx, RadialPlayerActivity::class.java).putExtra(
                    EXTRA_SONG_ID,
                    songId
                )
            )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRadialPlayerBinding.inflate(layoutInflater)
    ...
    private fun updateSkipRegionsUI(regions: List<SkipRegion>) {
        ...
        regions.forEach { region ->
            ...
            itemView.findViewById<android.widget.TextView>(R.id.tvItemName).apply {
                ...
                12f
            ); setTextColor(ContextCompat.getColor(this@RadialPlayerActivity, R.color.neon_yellow))
            }
            itemView.findViewById<ImageView>(R.id.ivItemIcon).apply {
                setImageResource(R.drawable.ic_close); setColorFilter(
                ContextCompat.getColor(
                    this@RadialPlayerActivity,
                    R.color.neon_red
                )
    ...
    private fun resetAllStates() {
        ...
        activityScope.launch {
            ...
            runOnUiThread {
                ...
                Toast.makeText(this@RadialPlayerActivity, "All states reset", Toast.LENGTH_SHORT)
                    .show()
            }
        }
    }
        ...
        progressRunnable = object : Runnable {
            override fun run() {
                ...
                if (fullDur > 0) {
                    ...
                    binding.tvCurrentTime.text = formatDuration(relPos); binding.tvTotalTime.text =
