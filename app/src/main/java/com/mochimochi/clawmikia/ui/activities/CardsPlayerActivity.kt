...
import com.mochimochi.clawmikiacrazy.databinding.ActivityNowPlayingCardsBinding
...
class CardsPlayerActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun start(ctx: Context, songId: Long) = ctx.startActivity(
            Intent(ctx, CardsPlayerActivity::class.java).putExtra(EXTRA_SONG_ID, songId)
        )
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(binding.root) { _, insets ->
            ...
            binding.scrollSections.setPadding(
                binding.scrollSections.paddingLeft,
                binding.scrollSections.paddingTop,
                binding.scrollSections.paddingRight,
    ...
    private fun adjustSpeed(delta: Int) {
        ...
        val speed = progressToSpeed(binding.cardSpeed.seekSpeed.progress)
    ...
    private fun updateSkipRegionsUI(regions: List<SkipRegion>) {
        ...
        regions.forEach { region ->
            ...
            itemView.findViewById<android.widget.TextView>(R.id.tvItemName).apply {
                ...
                setTextColor(ContextCompat.getColor(this@CardsPlayerActivity, R.color.neon_yellow))
            }
            itemView.findViewById<ImageView>(R.id.ivItemIcon).apply {
                setImageResource(R.drawable.ic_close)
                setColorFilter(ContextCompat.getColor(this@CardsPlayerActivity, R.color.neon_red))
